 ...
 */
public class CNSV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton7.setText("Danh sách lớp SV");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            switch(col+1){ 
                ...
                case 3: a = "LopSV"; break;
                case 4: a = "NgaySinh"; break;
                case 5: a = "GioiTinh"; break;
                case 6: a = "DiaChi"; break;
            }
            String sql = "update SV set " + a + " =? where MaSV=?";
            KetNoi kn = new KetNoi();
            Connection con = kn.getConnectionToSQL();
            PreparedStatement pst = con.prepareStatement(sql);
            pst.setString(1, JOptionPane.showInputDialog("Nhập dữ liệu mới cho " + a + " của sinh viên " +(String) jTable1.getValueAt(row, 0), jTable1.getValueAt(row, col)));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ThemSinhVien CNSV = new ThemSinhVien();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        jTable1.setModel(createModel());
        RowC = String.valueOf(jTable1.getRowCount());
        jLabel2.setText(RowC);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(key==null){
            JOptionPane.showMessageDialog(null, "Chọn hàng bạn muốn xóa.");
            return;
        }
        else if(JOptionPane.showConfirmDialog(null, "Bạn có chắc chắn muốn xóa sinh viên " + key + " ?", "Xác nhận xóa?", 2)==0){
            
            String sql = "delete from SV where MaSV='" + key + "'";
...
//                }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
            ...
            Report rp = new Report("src/baocao/etc/dslopsv.jasper", h);
        }
        else
 ...
 */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CNSV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
