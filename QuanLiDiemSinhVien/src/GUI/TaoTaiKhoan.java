...
public class TaoTaiKhoan extends javax.swing.JFrame {
    ...
    private int checkNewPass(){
        if(jPasswordField1.getText().equals(jPasswordField2.getText())) return 1;
        else return 0;
    }
    ...
    private int checkAcc(){
        ...
        String a = "select * from logon where name='" + jTextField1.getText() + "'";
        try {
            if(kn.getDataSQL(a).next()){
                return 0;
            }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Quản trị", "Giảng viên" }));
